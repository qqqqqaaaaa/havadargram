.class Litman/Vidofilm/glowpadbackport/Tweener;
...
.field private static sTweens:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "<",
            "Ljava/lang/Object;",
            "Litman/Vidofilm/glowpadbackport/Tweener;",
            ">;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Litman/Vidofilm/glowpadbackport/Tweener;->sTweens:Ljava/util/HashMap;

    new-instance v0, Litman/Vidofilm/glowpadbackport/Tweener$1;

    invoke-direct {v0}, Litman/Vidofilm/glowpadbackport/Tweener$1;-><init>()V

    sput-object v0, Litman/Vidofilm/glowpadbackport/Tweener;->mCleanupListener:Lcom/nineoldandroids/animation/Animator$AnimatorListener;
...
.method public constructor <init>(Lcom/nineoldandroids/animation/ObjectAnimator;)V
    ...
    iput-object p1, p0, Litman/Vidofilm/glowpadbackport/Tweener;->animator:Lcom/nineoldandroids/animation/ObjectAnimator;
...
.method static synthetic access$000(Lcom/nineoldandroids/animation/Animator;)V
    ...
    invoke-static {p0}, Litman/Vidofilm/glowpadbackport/Tweener;->remove(Lcom/nineoldandroids/animation/Animator;)V
...
.method private static remove(Lcom/nineoldandroids/animation/Animator;)V
    ...
    sget-object v0, Litman/Vidofilm/glowpadbackport/Tweener;->sTweens:Ljava/util/HashMap;
...
.method private static varargs replace(Ljava/util/ArrayList;[Ljava/lang/Object;)V
    ...
    sget-object v3, Litman/Vidofilm/glowpadbackport/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    iget-object v3, v0, Litman/Vidofilm/glowpadbackport/Tweener;->animator:Lcom/nineoldandroids/animation/ObjectAnimator;
...
.method public static varargs to(Ljava/lang/Object;J[Ljava/lang/Object;)Litman/Vidofilm/glowpadbackport/Tweener;
    .locals 17
    ...
    const-string/jumbo v4, "Key must be a string: "
    ...
    const-string/jumbo v4, "simultaneousTween"
    ...
    check-cast v2, Litman/Vidofilm/glowpadbackport/util/TimeInterpolator;
    ...
    const-string/jumbo v4, "onUpdateListener"
    ...
    const-string/jumbo v4, "onCompleteListener"
    ...
    :cond_7
    const-string/jumbo v4, "syncWith"
    ...
    const-string/jumbo v6, "Bad argument for key \""
    ...
    :cond_c
    sget-object v2, Litman/Vidofilm/glowpadbackport/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    check-cast v2, Litman/Vidofilm/glowpadbackport/Tweener;
    ...
    new-instance v3, Litman/Vidofilm/glowpadbackport/Tweener;

    invoke-direct {v3, v2}, Litman/Vidofilm/glowpadbackport/Tweener;-><init>(Lcom/nineoldandroids/animation/ObjectAnimator;)V

    sget-object v4, Litman/Vidofilm/glowpadbackport/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    :cond_f
    sget-object v4, Litman/Vidofilm/glowpadbackport/Tweener;->mCleanupListener:Lcom/nineoldandroids/animation/Animator$AnimatorListener;
    ...
    check-cast v3, Litman/Vidofilm/glowpadbackport/Tweener;

    iget-object v3, v3, Litman/Vidofilm/glowpadbackport/Tweener;->animator:Lcom/nineoldandroids/animation/ObjectAnimator;
    ...
    invoke-static {v11, v4}, Litman/Vidofilm/glowpadbackport/Tweener;->replace(Ljava/util/ArrayList;[Ljava/lang/Object;)V
...
# virtual methods
.method varargs from(Ljava/lang/Object;J[Ljava/lang/Object;)Litman/Vidofilm/glowpadbackport/Tweener;
    .locals 2

    invoke-static {p1, p2, p3, p4}, Litman/Vidofilm/glowpadbackport/Tweener;->to(Ljava/lang/Object;J[Ljava/lang/Object;)Litman/Vidofilm/glowpadbackport/Tweener;
