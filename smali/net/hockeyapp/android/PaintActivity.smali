...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v6, v0}, Lnet/hockeyapp/android/views/c;->a(Landroid/content/ContentResolver;Landroid/net/Uri;)I
    ...
    :cond_3
    new-instance v1, Lnet/hockeyapp/android/views/c;

    invoke-direct {v1, p0, v0, v4, v5}, Lnet/hockeyapp/android/views/c;-><init>(Landroid/content/Context;Landroid/net/Uri;II)V

    iput-object v1, p0, Lnet/hockeyapp/android/PaintActivity;->a:Lnet/hockeyapp/android/views/c;
    ...
    iget-object v2, p0, Lnet/hockeyapp/android/PaintActivity;->a:Lnet/hockeyapp/android/views/c;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    sget v1, Lnet/hockeyapp/android/i$d;->hockeyapp_paint_menu_undo:I
    ...
    sget v1, Lnet/hockeyapp/android/i$d;->hockeyapp_paint_menu_clear:I
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    sget v2, Lnet/hockeyapp/android/i$d;->hockeyapp_paint_dialog_message:I

    invoke-virtual {v1, v2}, Landroid/app/AlertDialog$Builder;->setMessage(I)Landroid/app/AlertDialog$Builder;

    move-result-object v1

    sget v2, Lnet/hockeyapp/android/i$d;->hockeyapp_paint_dialog_positive_button:I

    invoke-virtual {v1, v2, v0}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    move-result-object v1

    sget v2, Lnet/hockeyapp/android/i$d;->hockeyapp_paint_dialog_negative_button:I

    invoke-virtual {v1, v2, v0}, Landroid/app/AlertDialog$Builder;->setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    move-result-object v1

    sget v2, Lnet/hockeyapp/android/i$d;->hockeyapp_paint_dialog_neutral_button:I
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v1}, Lnet/hockeyapp/android/views/c;->b()V
    ...
    invoke-virtual {v1}, Lnet/hockeyapp/android/views/c;->a()V
