.class Lorg/vidogram/ui/ThemeActivity$ListAdapter;
.super Lorg/vidogram/ui/Components/RecyclerListView$SelectionAdapter;


# annotations
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lorg/vidogram/ui/ThemeActivity;
.end annotation
...
# direct methods
.method public constructor <init>(Lorg/vidogram/ui/ThemeActivity;Landroid/content/Context;)V
    .locals 0

    iput-object p1, p0, Lorg/vidogram/ui/ThemeActivity$ListAdapter;->this$0:Lorg/vidogram/ui/ThemeActivity;

    invoke-direct {p0}, Lorg/vidogram/ui/Components/RecyclerListView$SelectionAdapter;-><init>()V

    iput-object p2, p0, Lorg/vidogram/ui/ThemeActivity$ListAdapter;->mContext:Landroid/content/Context;
...
.method public onBindViewHolder(Lorg/vidogram/messenger/support/widget/RecyclerView$ViewHolder;I)V
    ...
    check-cast v1, Lorg/vidogram/ui/Cells/ThemeCell;

    sget-object v3, Lorg/vidogram/ui/ActionBar/Theme;->themes:Ljava/util/ArrayList;
    ...
    :goto_0
    invoke-virtual {v1, v0, v2}, Lorg/vidogram/ui/Cells/ThemeCell;->setTheme(Lorg/vidogram/ui/ActionBar/Theme$ThemeInfo;Z)V
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Lorg/vidogram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    iget-object v0, p0, Lorg/vidogram/ui/ThemeActivity$ListAdapter;->mContext:Landroid/content/Context;
    ...
    :pswitch_0
    new-instance v1, Lorg/vidogram/ui/Cells/ThemeCell;

    iget-object v0, p0, Lorg/vidogram/ui/ThemeActivity$ListAdapter;->mContext:Landroid/content/Context;

    invoke-direct {v1, v0}, Lorg/vidogram/ui/Cells/ThemeCell;-><init>(Landroid/content/Context;)V
    ...
    check-cast v0, Lorg/vidogram/ui/Cells/ThemeCell;

    new-instance v2, Lorg/vidogram/ui/ThemeActivity$ListAdapter$1;

    invoke-direct {v2, p0}, Lorg/vidogram/ui/ThemeActivity$ListAdapter$1;-><init>(Lorg/vidogram/ui/ThemeActivity$ListAdapter;)V

    invoke-virtual {v0, v2}, Lorg/vidogram/ui/Cells/ThemeCell;->setOnOptionsClick(Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {v0, v2, v3}, Lorg/vidogram/ui/Cells/TextSettingsCell;->setText(Ljava/lang/String;Z)V
