.class Lorg/vidogram/ui/Components/ShareAlert$ShareDialogsAdapter;
...
.method public constructor <init>(Lorg/vidogram/ui/Components/ShareAlert;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lorg/vidogram/ui/Components/ShareAlert$ShareDialogsAdapter;->this$0:Lorg/vidogram/ui/Components/ShareAlert;
    ...
    iput-object v0, p0, Lorg/vidogram/ui/Components/ShareAlert$ShareDialogsAdapter;->dialogs:Ljava/util/ArrayList;

    iput-object p2, p0, Lorg/vidogram/ui/Components/ShareAlert$ShareDialogsAdapter;->context:Landroid/content/Context;

    invoke-virtual {p0}, Lorg/vidogram/ui/Components/ShareAlert$ShareDialogsAdapter;->fetchDialogs()V

    return-void
.end method

.method static synthetic access$2400(Lorg/vidogram/ui/Components/ShareAlert$ShareDialogsAdapter;)Ljava/util/ArrayList;
    .locals 1

    iget-object v0, p0, Lorg/vidogram/ui/Components/ShareAlert$ShareDialogsAdapter;->dialogs:Ljava/util/ArrayList;
...
.method public fetchDialogs()V
    ...
    iget-object v2, p0, Lorg/vidogram/ui/Components/ShareAlert$ShareDialogsAdapter;->dialogs:Ljava/util/ArrayList;
    ...
    iget-boolean v3, v2, Lorg/vidogram/tgnet/TLRPC$Chat;->creator:Z

    if-nez v3, :cond_2

    iget-boolean v3, v2, Lorg/vidogram/tgnet/TLRPC$Chat;->editor:Z
    ...
    :cond_3
    invoke-virtual {p0}, Lorg/vidogram/ui/Components/ShareAlert$ShareDialogsAdapter;->notifyDataSetChanged()V
...
.method public onBindViewHolder(Lorg/vidogram/messenger/support/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-virtual {p0, p2}, Lorg/vidogram/ui/Components/ShareAlert$ShareDialogsAdapter;->getItem(I)Lorg/vidogram/tgnet/TLRPC$TL_dialog;
    ...
    iget-object v3, p0, Lorg/vidogram/ui/Components/ShareAlert$ShareDialogsAdapter;->this$0:Lorg/vidogram/ui/Components/ShareAlert;
    ...
    invoke-virtual {v0, v2, v1, v3}, Lorg/vidogram/ui/Cells/ShareDialogCell;->setDialog(IZLjava/lang/CharSequence;)V
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Lorg/vidogram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    iget-object v1, p0, Lorg/vidogram/ui/Components/ShareAlert$ShareDialogsAdapter;->context:Landroid/content/Context;
