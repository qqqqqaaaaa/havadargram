.class public Lorg/vidogram/ui/Components/voip/VoIPHelper;
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lorg/vidogram/ui/Components/voip/VoIPHelper;->lastCallRequestTime:J
...
.method static synthetic access$000(Lorg/vidogram/tgnet/TLRPC$User;Landroid/app/Activity;)V
    .locals 0

    invoke-static {p0, p1}, Lorg/vidogram/ui/Components/voip/VoIPHelper;->doInitiateCall(Lorg/vidogram/tgnet/TLRPC$User;Landroid/app/Activity;)V

    return-void
.end method

.method private static doInitiateCall(Lorg/vidogram/tgnet/TLRPC$User;Landroid/app/Activity;)V
    .locals 5
    ...
    sget-wide v2, Lorg/vidogram/ui/Components/voip/VoIPHelper;->lastCallRequestTime:J
    ...
    const-class v1, Lorg/vidogram/messenger/voip/VoIPService;
...
.method private static initiateCall(Lorg/vidogram/tgnet/TLRPC$User;Landroid/app/Activity;)V
    .locals 7
    ...
    invoke-virtual {v0}, Lorg/vidogram/messenger/voip/VoIPService;->getUser()Lorg/vidogram/tgnet/TLRPC$User;
    ...
    invoke-direct {v1, p1}, Lorg/vidogram/ui/ActionBar/AlertDialog$Builder;-><init>(Landroid/content/Context;)V
    ...
    iget-object v5, p0, Lorg/vidogram/tgnet/TLRPC$User;->first_name:Ljava/lang/String;

    iget-object v6, p0, Lorg/vidogram/tgnet/TLRPC$User;->last_name:Ljava/lang/String;
    ...
    new-instance v2, Lorg/vidogram/ui/Components/voip/VoIPHelper$2;

    invoke-direct {v2, p0, p1}, Lorg/vidogram/ui/Components/voip/VoIPHelper$2;-><init>(Lorg/vidogram/tgnet/TLRPC$User;Landroid/app/Activity;)V
...
.method public static permissionDenied(Landroid/app/Activity;Ljava/lang/Runnable;)V
    ...
    new-instance v2, Lorg/vidogram/ui/Components/voip/VoIPHelper$3;

    invoke-direct {v2, p0}, Lorg/vidogram/ui/Components/voip/VoIPHelper$3;-><init>(Landroid/app/Activity;)V
    ...
    new-instance v1, Lorg/vidogram/ui/Components/voip/VoIPHelper$4;

    invoke-direct {v1, p1}, Lorg/vidogram/ui/Components/voip/VoIPHelper$4;-><init>(Ljava/lang/Runnable;)V
...
.method public static startCall(Lorg/vidogram/tgnet/TLRPC$User;Landroid/app/Activity;Lorg/vidogram/tgnet/TLRPC$TL_userFull;)V
    .locals 9
    ...
    iget-boolean v2, p2, Lorg/vidogram/tgnet/TLRPC$TL_userFull;->phone_calls_private:Z

    if-eqz v2, :cond_0

    new-instance v2, Lorg/vidogram/ui/ActionBar/AlertDialog$Builder;

    invoke-direct {v2, p1}, Lorg/vidogram/ui/ActionBar/AlertDialog$Builder;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v3, v4, v0}, Lorg/vidogram/messenger/LocaleController;->formatString(Ljava/lang/String;I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v8}, Lorg/vidogram/ui/ActionBar/AlertDialog$Builder;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Lorg/vidogram/ui/ActionBar/AlertDialog$Builder;
    ...
    invoke-virtual {v1, v2, v8}, Lorg/vidogram/ui/ActionBar/AlertDialog$Builder;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Lorg/vidogram/ui/ActionBar/AlertDialog$Builder;
    ...
    new-instance v3, Lorg/vidogram/ui/Components/voip/VoIPHelper$1;

    invoke-direct {v3, p1, v0}, Lorg/vidogram/ui/Components/voip/VoIPHelper$1;-><init>(Landroid/app/Activity;Landroid/content/Intent;)V
    ...
    :cond_6
    invoke-static {p0, p1}, Lorg/vidogram/ui/Components/voip/VoIPHelper;->initiateCall(Lorg/vidogram/tgnet/TLRPC$User;Landroid/app/Activity;)V
