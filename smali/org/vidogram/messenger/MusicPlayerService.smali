.class public Lorg/vidogram/messenger/MusicPlayerService;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lorg/vidogram/messenger/MusicPlayerService;->supportBigNotifications:Z
    ...
    :goto_1
    sput-boolean v1, Lorg/vidogram/messenger/MusicPlayerService;->supportLockScreenControls:Z
...
.method private createNotification(Lorg/vidogram/messenger/MessageObject;)V
    .locals 13
    ...
    invoke-virtual {p0}, Lorg/vidogram/messenger/MusicPlayerService;->getApplicationContext()Landroid/content/Context;
    ...
    sget-boolean v5, Lorg/vidogram/messenger/MusicPlayerService;->supportBigNotifications:Z
    ...
    new-instance v6, Landroid/support/v4/b/r$d;

    invoke-virtual {p0}, Lorg/vidogram/messenger/MusicPlayerService;->getApplicationContext()Landroid/content/Context;

    move-result-object v7

    invoke-direct {v6, v7}, Landroid/support/v4/b/r$d;-><init>(Landroid/content/Context;)V

    const v7, 0x7f02021d

    invoke-virtual {v6, v7}, Landroid/support/v4/b/r$d;->a(I)Landroid/support/v4/b/r$d;

    move-result-object v6

    invoke-virtual {v6, v5}, Landroid/support/v4/b/r$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/b/r$d;

    move-result-object v5

    invoke-virtual {v5, v1}, Landroid/support/v4/b/r$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/b/r$d;
    ...
    sget-boolean v6, Lorg/vidogram/messenger/MusicPlayerService;->supportBigNotifications:Z
    ...
    :cond_1
    invoke-virtual {p0, v4}, Lorg/vidogram/messenger/MusicPlayerService;->setListeners(Landroid/widget/RemoteViews;)V

    sget-boolean v4, Lorg/vidogram/messenger/MusicPlayerService;->supportBigNotifications:Z

    if-eqz v4, :cond_2

    invoke-virtual {p0, v0}, Lorg/vidogram/messenger/MusicPlayerService;->setListeners(Landroid/widget/RemoteViews;)V

    :cond_2
    if-eqz v3, :cond_8

    invoke-virtual {v3}, Lorg/vidogram/messenger/audioinfo/AudioInfo;->getSmallCover()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v0}, Lorg/vidogram/messenger/MediaController;->isDownloadingCurrentMessage()Z
    ...
    sget-boolean v0, Lorg/vidogram/messenger/MusicPlayerService;->supportBigNotifications:Z
    ...
    invoke-virtual {p0, v0, v5}, Lorg/vidogram/messenger/MusicPlayerService;->startForeground(ILandroid/app/Notification;)V

    iget-object v0, p0, Lorg/vidogram/messenger/MusicPlayerService;->remoteControlClient:Landroid/media/RemoteControlClient;
    ...
    invoke-virtual {v3}, Lorg/vidogram/messenger/audioinfo/AudioInfo;->getCover()Landroid/graphics/Bitmap;
...
.method public varargs didReceivedNotification(I[Ljava/lang/Object;)V
    ...
    invoke-direct {p0, v0}, Lorg/vidogram/messenger/MusicPlayerService;->createNotification(Lorg/vidogram/messenger/MessageObject;)V
    ...
    :cond_1
    invoke-virtual {p0}, Lorg/vidogram/messenger/MusicPlayerService;->stopSelf()V
...
.method public onCreate()V
    ...
    invoke-virtual {p0, v0}, Lorg/vidogram/messenger/MusicPlayerService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/media/AudioManager;

    iput-object v0, p0, Lorg/vidogram/messenger/MusicPlayerService;->audioManager:Landroid/media/AudioManager;
...
.method public onDestroy()V
    ...
    iget-object v0, p0, Lorg/vidogram/messenger/MusicPlayerService;->audioManager:Landroid/media/AudioManager;

    iget-object v1, p0, Lorg/vidogram/messenger/MusicPlayerService;->remoteControlClient:Landroid/media/RemoteControlClient;
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    new-instance v0, Lorg/vidogram/messenger/MusicPlayerService$1;

    invoke-direct {v0, p0}, Lorg/vidogram/messenger/MusicPlayerService$1;-><init>(Lorg/vidogram/messenger/MusicPlayerService;)V
    ...
    :cond_0
    sget-boolean v0, Lorg/vidogram/messenger/MusicPlayerService;->supportLockScreenControls:Z
    ...
    const-class v3, Lorg/vidogram/messenger/MusicPlayerReceiver;
    ...
    :try_start_1
    iget-object v2, p0, Lorg/vidogram/messenger/MusicPlayerService;->remoteControlClient:Landroid/media/RemoteControlClient;

    if-nez v2, :cond_1

    iget-object v2, p0, Lorg/vidogram/messenger/MusicPlayerService;->audioManager:Landroid/media/AudioManager;
    ...
    iput-object v2, p0, Lorg/vidogram/messenger/MusicPlayerService;->remoteControlClient:Landroid/media/RemoteControlClient;
    ...
    :goto_1
    :try_start_2
    invoke-direct {p0, v1}, Lorg/vidogram/messenger/MusicPlayerService;->createNotification(Lorg/vidogram/messenger/MessageObject;)V
    :try_end_2
