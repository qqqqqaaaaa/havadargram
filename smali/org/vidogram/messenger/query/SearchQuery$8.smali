.class final Lorg/vidogram/messenger/query/SearchQuery$8;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/vidogram/messenger/query/SearchQuery;->savePeer(IID)V
.end annotation
...
.method constructor <init>(IID)V
    ...
    iput p1, p0, Lorg/vidogram/messenger/query/SearchQuery$8;->val$did:I

    iput p2, p0, Lorg/vidogram/messenger/query/SearchQuery$8;->val$type:I

    iput-wide p3, p0, Lorg/vidogram/messenger/query/SearchQuery$8;->val$rating:D
...
.method public run()V
    ...
    iget v2, p0, Lorg/vidogram/messenger/query/SearchQuery$8;->val$did:I

    invoke-virtual {v0, v1, v2}, Lorg/vidogram/SQLite/SQLitePreparedStatement;->bindInteger(II)V

    const/4 v1, 0x2

    iget v2, p0, Lorg/vidogram/messenger/query/SearchQuery$8;->val$type:I

    invoke-virtual {v0, v1, v2}, Lorg/vidogram/SQLite/SQLitePreparedStatement;->bindInteger(II)V

    const/4 v1, 0x3

    iget-wide v2, p0, Lorg/vidogram/messenger/query/SearchQuery$8;->val$rating:D

    invoke-virtual {v0, v1, v2, v3}, Lorg/vidogram/SQLite/SQLitePreparedStatement;->bindDouble(ID)V
