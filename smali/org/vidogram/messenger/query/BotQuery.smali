.class public Lorg/vidogram/messenger/query/BotQuery;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/vidogram/messenger/query/BotQuery;->botInfos:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lorg/vidogram/messenger/query/BotQuery;->botKeyboards:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lorg/vidogram/messenger/query/BotQuery;->botKeyboardsByMids:Ljava/util/HashMap;
...
.method static synthetic access$000()Ljava/util/HashMap;
    ...
    sget-object v0, Lorg/vidogram/messenger/query/BotQuery;->botKeyboardsByMids:Ljava/util/HashMap;
...
.method static synthetic access$100()Ljava/util/HashMap;
    ...
    sget-object v0, Lorg/vidogram/messenger/query/BotQuery;->botKeyboards:Ljava/util/HashMap;
...
.method public static cleanup()V
    ...
    sget-object v0, Lorg/vidogram/messenger/query/BotQuery;->botInfos:Ljava/util/HashMap;
...
.method public static clearBotKeyboard(JLjava/util/ArrayList;)V
    ...
    new-instance v0, Lorg/vidogram/messenger/query/BotQuery$1;

    invoke-direct {v0, p2, p0, p1}, Lorg/vidogram/messenger/query/BotQuery$1;-><init>(Ljava/util/ArrayList;J)V
...
.method public static loadBotInfo(IZI)V
    ...
    new-instance v1, Lorg/vidogram/messenger/query/BotQuery$3;

    invoke-direct {v1, p0, p2}, Lorg/vidogram/messenger/query/BotQuery$3;-><init>(II)V
...
.method public static loadBotKeyboard(J)V
    ...
    sget v2, Lorg/vidogram/messenger/NotificationCenter;->botKeyboardDidLoaded:I
    ...
    new-instance v1, Lorg/vidogram/messenger/query/BotQuery$2;

    invoke-direct {v1, p0, p1}, Lorg/vidogram/messenger/query/BotQuery$2;-><init>(J)V
...
.method public static putBotInfo(Lorg/vidogram/tgnet/TLRPC$BotInfo;)V
    .locals 2
    ...
    iget v1, p0, Lorg/vidogram/tgnet/TLRPC$BotInfo;->user_id:I
    ...
    new-instance v1, Lorg/vidogram/messenger/query/BotQuery$5;

    invoke-direct {v1, p0}, Lorg/vidogram/messenger/query/BotQuery$5;-><init>(Lorg/vidogram/tgnet/TLRPC$BotInfo;)V
...
.method public static putBotKeyboard(JLorg/vidogram/tgnet/TLRPC$Message;)V
    .locals 8
    ...
    iget v1, p2, Lorg/vidogram/tgnet/TLRPC$Message;->id:I
    ...
    invoke-virtual {p2}, Lorg/vidogram/tgnet/TLRPC$Message;->getObjectSize()I

    move-result v2

    invoke-direct {v1, v2}, Lorg/vidogram/tgnet/NativeByteBuffer;-><init>(I)V

    invoke-virtual {p2, v1}, Lorg/vidogram/tgnet/TLRPC$Message;->serializeToStream(Lorg/vidogram/tgnet/AbstractSerializedData;)V

    const/4 v2, 0x1

    invoke-virtual {v0, v2, p0, p1}, Lorg/vidogram/SQLite/SQLitePreparedStatement;->bindLong(IJ)V

    const/4 v2, 0x2

    iget v3, p2, Lorg/vidogram/tgnet/TLRPC$Message;->id:I
    ...
    new-instance v0, Lorg/vidogram/messenger/query/BotQuery$4;

    invoke-direct {v0, p0, p1, p2}, Lorg/vidogram/messenger/query/BotQuery$4;-><init>(JLorg/vidogram/tgnet/TLRPC$Message;)V
