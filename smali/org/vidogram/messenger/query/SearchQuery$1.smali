.class final Lorg/vidogram/messenger/query/SearchQuery$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/vidogram/messenger/query/SearchQuery;->buildShortcuts()V
.end annotation
...
.method constructor <init>(Ljava/util/ArrayList;)V
    ...
    iput-object p1, p0, Lorg/vidogram/messenger/query/SearchQuery$1;->val$hintsFinal:Ljava/util/ArrayList;
...
.method public run()V
    ...
    iget-object v3, v0, Lorg/vidogram/messenger/query/SearchQuery$1;->val$hintsFinal:Ljava/util/ArrayList;
    ...
    check-cast v3, Lorg/vidogram/tgnet/TLRPC$TL_topPeer;

    iget-object v6, v3, Lorg/vidogram/tgnet/TLRPC$TL_topPeer;->peer:Lorg/vidogram/tgnet/TLRPC$Peer;

    iget v6, v6, Lorg/vidogram/tgnet/TLRPC$Peer;->user_id:I

    if-eqz v6, :cond_1

    iget-object v3, v3, Lorg/vidogram/tgnet/TLRPC$TL_topPeer;->peer:Lorg/vidogram/tgnet/TLRPC$Peer;
    ...
    const-class v5, Lorg/vidogram/ui/LaunchActivity;
    ...
    const-class v5, Lorg/vidogram/messenger/OpenChatReceiver;
    ...
    iget-object v7, v3, Lorg/vidogram/tgnet/TLRPC$TL_topPeer;->peer:Lorg/vidogram/tgnet/TLRPC$Peer;
    ...
    :cond_9
    iget-object v5, v3, Lorg/vidogram/tgnet/TLRPC$TL_topPeer;->peer:Lorg/vidogram/tgnet/TLRPC$Peer;
    ...
    iget-object v5, v7, Lorg/vidogram/tgnet/TLRPC$User;->first_name:Ljava/lang/String;

    iget-object v6, v7, Lorg/vidogram/tgnet/TLRPC$User;->last_name:Ljava/lang/String;
    ...
    iget-object v6, v7, Lorg/vidogram/tgnet/TLRPC$User;->photo:Lorg/vidogram/tgnet/TLRPC$UserProfilePhoto;

    if-eqz v6, :cond_b

    iget-object v3, v7, Lorg/vidogram/tgnet/TLRPC$User;->photo:Lorg/vidogram/tgnet/TLRPC$UserProfilePhoto;
    ...
    # getter for: Lorg/vidogram/messenger/query/SearchQuery;->roundPaint:Landroid/graphics/Paint;
    invoke-static {}, Lorg/vidogram/messenger/query/SearchQuery;->access$000()Landroid/graphics/Paint;
    ...
    # setter for: Lorg/vidogram/messenger/query/SearchQuery;->roundPaint:Landroid/graphics/Paint;
    invoke-static {v15}, Lorg/vidogram/messenger/query/SearchQuery;->access$002(Landroid/graphics/Paint;)Landroid/graphics/Paint;

    new-instance v15, Landroid/graphics/RectF;

    invoke-direct {v15}, Landroid/graphics/RectF;-><init>()V

    # setter for: Lorg/vidogram/messenger/query/SearchQuery;->bitmapRect:Landroid/graphics/RectF;
    invoke-static {v15}, Lorg/vidogram/messenger/query/SearchQuery;->access$102(Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    # getter for: Lorg/vidogram/messenger/query/SearchQuery;->bitmapRect:Landroid/graphics/RectF;
    invoke-static {}, Lorg/vidogram/messenger/query/SearchQuery;->access$100()Landroid/graphics/RectF;

    move-result-object v7

    const/high16 v14, 0x40000000    # 2.0f

    invoke-static {v14}, Lorg/vidogram/messenger/AndroidUtilities;->dp(F)I
    ...
    invoke-static {v15}, Lorg/vidogram/messenger/AndroidUtilities;->dp(F)I
    ...
    invoke-static/range {v16 .. v16}, Lorg/vidogram/messenger/AndroidUtilities;->dp(F)I
    ...
    invoke-static/range {v17 .. v17}, Lorg/vidogram/messenger/AndroidUtilities;->dp(F)I
    ...
    :cond_e
    iget-object v5, v6, Lorg/vidogram/tgnet/TLRPC$Chat;->title:Ljava/lang/String;

    iget-object v7, v6, Lorg/vidogram/tgnet/TLRPC$Chat;->photo:Lorg/vidogram/tgnet/TLRPC$ChatPhoto;

    if-eqz v7, :cond_b

    iget-object v3, v6, Lorg/vidogram/tgnet/TLRPC$Chat;->photo:Lorg/vidogram/tgnet/TLRPC$ChatPhoto;
