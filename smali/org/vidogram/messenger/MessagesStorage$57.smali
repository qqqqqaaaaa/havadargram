.class Lorg/vidogram/messenger/MessagesStorage$57;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/vidogram/messenger/MessagesStorage;->updateEncryptedChat(Lorg/vidogram/tgnet/TLRPC$EncryptedChat;)V
.end annotation
...
.method constructor <init>(Lorg/vidogram/messenger/MessagesStorage;Lorg/vidogram/tgnet/TLRPC$EncryptedChat;)V
    ...
    iput-object p1, p0, Lorg/vidogram/messenger/MessagesStorage$57;->this$0:Lorg/vidogram/messenger/MessagesStorage;

    iput-object p2, p0, Lorg/vidogram/messenger/MessagesStorage$57;->val$chat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;
...
.method public run()V
    ...
    :try_start_0
    iget-object v2, p0, Lorg/vidogram/messenger/MessagesStorage$57;->val$chat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;

    iget-object v2, v2, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->key_hash:[B
    ...
    iget-object v3, p0, Lorg/vidogram/messenger/MessagesStorage$57;->val$chat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;

    iget-object v3, v3, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->auth_key:[B

    invoke-static {v3}, Lorg/vidogram/messenger/AndroidUtilities;->calcAuthKeyHash([B)[B

    move-result-object v3

    iput-object v3, v2, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->key_hash:[B

    :cond_1
    iget-object v2, p0, Lorg/vidogram/messenger/MessagesStorage$57;->this$0:Lorg/vidogram/messenger/MessagesStorage;
    ...
    invoke-virtual {v2}, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->getObjectSize()I

    move-result v2

    invoke-direct {v3, v2}, Lorg/vidogram/tgnet/NativeByteBuffer;-><init>(I)V

    new-instance v4, Lorg/vidogram/tgnet/NativeByteBuffer;

    iget-object v2, p0, Lorg/vidogram/messenger/MessagesStorage$57;->val$chat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;

    iget-object v2, v2, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->a_or_b:[B
    ...
    :goto_0
    invoke-direct {v4, v2}, Lorg/vidogram/tgnet/NativeByteBuffer;-><init>(I)V
    ...
    :goto_1
    invoke-direct {v5, v2}, Lorg/vidogram/tgnet/NativeByteBuffer;-><init>(I)V

    new-instance v6, Lorg/vidogram/tgnet/NativeByteBuffer;

    iget-object v2, p0, Lorg/vidogram/messenger/MessagesStorage$57;->val$chat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;

    iget-object v2, v2, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->future_auth_key:[B
    ...
    :goto_2
    invoke-direct {v6, v2}, Lorg/vidogram/tgnet/NativeByteBuffer;-><init>(I)V

    new-instance v2, Lorg/vidogram/tgnet/NativeByteBuffer;

    iget-object v7, p0, Lorg/vidogram/messenger/MessagesStorage$57;->val$chat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;

    iget-object v7, v7, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->key_hash:[B

    if-eqz v7, :cond_2

    iget-object v0, p0, Lorg/vidogram/messenger/MessagesStorage$57;->val$chat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;
    ...
    invoke-virtual {v1, v0, v3}, Lorg/vidogram/SQLite/SQLitePreparedStatement;->bindByteBuffer(ILorg/vidogram/tgnet/NativeByteBuffer;)V
    ...
    invoke-virtual {v1, v0, v4}, Lorg/vidogram/SQLite/SQLitePreparedStatement;->bindByteBuffer(ILorg/vidogram/tgnet/NativeByteBuffer;)V

    const/4 v0, 0x3

    invoke-virtual {v1, v0, v5}, Lorg/vidogram/SQLite/SQLitePreparedStatement;->bindByteBuffer(ILorg/vidogram/tgnet/NativeByteBuffer;)V
    ...
    invoke-virtual {v1, v0, v7}, Lorg/vidogram/SQLite/SQLitePreparedStatement;->bindInteger(II)V
    ...
    iget-object v8, p0, Lorg/vidogram/messenger/MessagesStorage$57;->val$chat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;
    ...
    invoke-virtual {v1, v0, v8, v9}, Lorg/vidogram/SQLite/SQLitePreparedStatement;->bindLong(IJ)V
    ...
    invoke-virtual {v1, v0, v6}, Lorg/vidogram/SQLite/SQLitePreparedStatement;->bindByteBuffer(ILorg/vidogram/tgnet/NativeByteBuffer;)V
