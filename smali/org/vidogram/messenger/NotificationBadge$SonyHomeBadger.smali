.class public Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger;->BADGE_CONTENT_URI:Landroid/net/Uri;
...
.method private static executeBadgeByBroadcast(I)V
    ...
    new-instance v0, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger$1;

    invoke-direct {v0, v1}, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger$1;-><init>(Landroid/content/Intent;)V
...
.method private executeBadgeByContentProvider(I)V
    ...
    :cond_0
    sget-object v0, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger;->mQueryHandler:Landroid/content/AsyncQueryHandler;

    if-nez v0, :cond_1

    new-instance v0, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger$2;
    ...
    invoke-direct {v0, p0, v1}, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger$2;-><init>(Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger;Landroid/content/ContentResolver;)V

    sput-object v0, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger;->mQueryHandler:Landroid/content/AsyncQueryHandler;
    ...
    invoke-direct {p0, p1, v0, v1}, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger;->insertBadgeAsync(ILjava/lang/String;Ljava/lang/String;)V
...
.method private insertBadgeAsync(ILjava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v1, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger;->mQueryHandler:Landroid/content/AsyncQueryHandler;

    const/4 v2, 0x0

    const/4 v3, 0x0

    iget-object v4, p0, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger;->BADGE_CONTENT_URI:Landroid/net/Uri;
...
.method public executeBadge(I)V
    ...
    invoke-static {}, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger;->sonyBadgeContentProviderExists()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0, p1}, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger;->executeBadgeByContentProvider(I)V

    :goto_0
    return-void

    :cond_0
    invoke-static {p1}, Lorg/vidogram/messenger/NotificationBadge$SonyHomeBadger;->executeBadgeByBroadcast(I)V
