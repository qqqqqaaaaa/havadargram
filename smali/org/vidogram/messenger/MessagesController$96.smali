.class Lorg/vidogram/messenger/MessagesController$96;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/vidogram/messenger/MessagesController;->loadPinnedDialogs(JLjava/util/ArrayList;)V
.end annotation
...
# direct methods
.method constructor <init>(Lorg/vidogram/messenger/MessagesController;Ljava/util/ArrayList;J)V
    .locals 1

    iput-object p1, p0, Lorg/vidogram/messenger/MessagesController$96;->this$0:Lorg/vidogram/messenger/MessagesController;

    iput-object p2, p0, Lorg/vidogram/messenger/MessagesController$96;->val$order:Ljava/util/ArrayList;

    iput-wide p3, p0, Lorg/vidogram/messenger/MessagesController$96;->val$newDialogId:J
...
.method public run(Lorg/vidogram/tgnet/TLObject;Lorg/vidogram/tgnet/TLRPC$TL_error;)V
    ...
    check-cast v2, Lorg/vidogram/tgnet/TLRPC$TL_messages_peerDialogs;

    new-instance v5, Lorg/vidogram/tgnet/TLRPC$TL_messages_dialogs;

    invoke-direct {v5}, Lorg/vidogram/tgnet/TLRPC$TL_messages_dialogs;-><init>()V

    iget-object v0, v5, Lorg/vidogram/tgnet/TLRPC$TL_messages_dialogs;->users:Ljava/util/ArrayList;

    iget-object v1, v2, Lorg/vidogram/tgnet/TLRPC$TL_messages_peerDialogs;->users:Ljava/util/ArrayList;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iget-object v0, v5, Lorg/vidogram/tgnet/TLRPC$TL_messages_dialogs;->chats:Ljava/util/ArrayList;

    iget-object v1, v2, Lorg/vidogram/tgnet/TLRPC$TL_messages_peerDialogs;->chats:Ljava/util/ArrayList;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iget-object v0, v5, Lorg/vidogram/tgnet/TLRPC$TL_messages_dialogs;->dialogs:Ljava/util/ArrayList;

    iget-object v1, v2, Lorg/vidogram/tgnet/TLRPC$TL_messages_peerDialogs;->dialogs:Ljava/util/ArrayList;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iget-object v0, v5, Lorg/vidogram/tgnet/TLRPC$TL_messages_dialogs;->messages:Ljava/util/ArrayList;

    iget-object v1, v2, Lorg/vidogram/tgnet/TLRPC$TL_messages_peerDialogs;->messages:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v0, v2, Lorg/vidogram/tgnet/TLRPC$TL_messages_peerDialogs;->users:Ljava/util/ArrayList;
    ...
    :goto_1
    iget-object v0, v2, Lorg/vidogram/tgnet/TLRPC$TL_messages_peerDialogs;->chats:Ljava/util/ArrayList;
    ...
    :goto_2
    iget-object v0, v2, Lorg/vidogram/tgnet/TLRPC$TL_messages_peerDialogs;->messages:Ljava/util/ArrayList;
    ...
    invoke-direct {v1, v0, v7, v8, v9}, Lorg/vidogram/messenger/MessageObject;-><init>(Lorg/vidogram/tgnet/TLRPC$Message;Ljava/util/AbstractMap;Ljava/util/AbstractMap;Z)V
    ...
    :goto_4
    iget-object v0, v2, Lorg/vidogram/tgnet/TLRPC$TL_messages_peerDialogs;->dialogs:Ljava/util/ArrayList;
    ...
    :cond_c
    iget-object v1, p0, Lorg/vidogram/messenger/MessagesController$96;->this$0:Lorg/vidogram/messenger/MessagesController;
    ...
    :cond_d
    iget-object v7, p0, Lorg/vidogram/messenger/MessagesController$96;->this$0:Lorg/vidogram/messenger/MessagesController;
    ...
    new-instance v0, Lorg/vidogram/messenger/MessagesController$96$1;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lorg/vidogram/messenger/MessagesController$96$1;-><init>(Lorg/vidogram/messenger/MessagesController$96;Lorg/vidogram/tgnet/TLRPC$TL_messages_peerDialogs;Ljava/util/ArrayList;Ljava/util/HashMap;Lorg/vidogram/tgnet/TLRPC$TL_messages_dialogs;)V
