.class Lorg/vidogram/messenger/ImageLoader$CacheOutTask;
...
# instance fields
.field private cacheImage:Lorg/vidogram/messenger/ImageLoader$CacheImage;
...
# direct methods
.method public constructor <init>(Lorg/vidogram/messenger/ImageLoader;Lorg/vidogram/messenger/ImageLoader$CacheImage;)V
    .locals 1

    iput-object p1, p0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->this$0:Lorg/vidogram/messenger/ImageLoader;
    ...
    iput-object v0, p0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->sync:Ljava/lang/Object;

    iput-object p2, p0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->cacheImage:Lorg/vidogram/messenger/ImageLoader$CacheImage;

    return-void
.end method

.method static synthetic access$1700(Lorg/vidogram/messenger/ImageLoader$CacheOutTask;)Lorg/vidogram/messenger/ImageLoader$CacheImage;
    .locals 1

    iget-object v0, p0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->cacheImage:Lorg/vidogram/messenger/ImageLoader$CacheImage;
...
.method private onPostExecute(Landroid/graphics/drawable/BitmapDrawable;)V
    ...
    new-instance v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask$1;

    invoke-direct {v0, p0, p1}, Lorg/vidogram/messenger/ImageLoader$CacheOutTask$1;-><init>(Lorg/vidogram/messenger/ImageLoader$CacheOutTask;Landroid/graphics/drawable/BitmapDrawable;)V
...
.method public cancel()V
    ...
    iget-object v1, p0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->sync:Ljava/lang/Object;
    ...
    :try_start_0
    iput-boolean v0, p0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->isCancelled:Z

    iget-object v0, p0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->runningThread:Ljava/lang/Thread;
...
.method public run()V
    ...
    iget-object v3, v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->sync:Ljava/lang/Object;
    ...
    iput-object v2, v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->runningThread:Ljava/lang/Thread;

    invoke-static {}, Ljava/lang/Thread;->interrupted()Z

    move-object/from16 v0, p0

    iget-boolean v2, v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->isCancelled:Z
    ...
    iget-object v2, v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->cacheImage:Lorg/vidogram/messenger/ImageLoader$CacheImage;

    iget-boolean v2, v2, Lorg/vidogram/messenger/ImageLoader$CacheImage;->animatedFile:Z
    ...
    new-instance v3, Lorg/vidogram/ui/Components/AnimatedFileDrawable;

    move-object/from16 v0, p0

    iget-object v2, v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->cacheImage:Lorg/vidogram/messenger/ImageLoader$CacheImage;

    iget-object v4, v2, Lorg/vidogram/messenger/ImageLoader$CacheImage;->finalFilePath:Ljava/io/File;

    move-object/from16 v0, p0

    iget-object v2, v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->cacheImage:Lorg/vidogram/messenger/ImageLoader$CacheImage;

    iget-object v2, v2, Lorg/vidogram/messenger/ImageLoader$CacheImage;->filter:Ljava/lang/String;
    ...
    :goto_1
    invoke-direct {v3, v4, v2}, Lorg/vidogram/ui/Components/AnimatedFileDrawable;-><init>(Ljava/io/File;Z)V

    invoke-static {}, Ljava/lang/Thread;->interrupted()Z

    move-object/from16 v0, p0

    invoke-direct {v0, v3}, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->onPostExecute(Landroid/graphics/drawable/BitmapDrawable;)V
    ...
    iget-object v14, v2, Lorg/vidogram/messenger/ImageLoader$CacheImage;->finalFilePath:Ljava/io/File;
    ...
    iget-object v3, v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->cacheImage:Lorg/vidogram/messenger/ImageLoader$CacheImage;

    iget-boolean v3, v3, Lorg/vidogram/messenger/ImageLoader$CacheImage;->thumb:Z

    if-eqz v3, :cond_7

    # getter for: Lorg/vidogram/messenger/ImageLoader;->headerThumb:[B
    invoke-static {}, Lorg/vidogram/messenger/ImageLoader;->access$1200()[B
    ...
    iget-object v4, v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->cacheImage:Lorg/vidogram/messenger/ImageLoader$CacheImage;

    iget-object v4, v4, Lorg/vidogram/messenger/ImageLoader$CacheImage;->filter:Ljava/lang/String;
    ...
    iget-object v3, v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->this$0:Lorg/vidogram/messenger/ImageLoader;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v4

    # setter for: Lorg/vidogram/messenger/ImageLoader;->lastCacheOutTime:J
    invoke-static {v3, v4, v5}, Lorg/vidogram/messenger/ImageLoader;->access$1402(Lorg/vidogram/messenger/ImageLoader;J)J
    ...
    iget-boolean v4, v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->isCancelled:Z
    ...
    invoke-direct {v0, v2}, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->onPostExecute(Landroid/graphics/drawable/BitmapDrawable;)V

    goto/16 :goto_0

    :cond_7
    :try_start_a
    # getter for: Lorg/vidogram/messenger/ImageLoader;->header:[B
    invoke-static {}, Lorg/vidogram/messenger/ImageLoader;->access$1300()[B
    :try_end_a
    ...
    invoke-static {v4, v3, v5, v2, v6}, Lorg/vidogram/messenger/Utilities;->loadWebpImage(Landroid/graphics/Bitmap;Ljava/nio/ByteBuffer;ILandroid/graphics/BitmapFactory$Options;Z)Z
    ...
    invoke-static {v4, v2, v5}, Lorg/vidogram/messenger/Bitmaps;->createBitmap(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    :try_end_f
    ...
    :goto_b
    invoke-static {v8, v3, v4, v5, v2}, Lorg/vidogram/messenger/Utilities;->loadWebpImage(Landroid/graphics/Bitmap;Ljava/nio/ByteBuffer;ILandroid/graphics/BitmapFactory$Options;Z)Z
    ...
    iget-object v3, v3, Lorg/vidogram/messenger/ImageLoader$CacheImage;->filter:Ljava/lang/String;
    ...
    # getter for: Lorg/vidogram/messenger/ImageLoader;->bytesThumb:[B
    invoke-static {}, Lorg/vidogram/messenger/ImageLoader;->access$1500()[B
    ...
    # setter for: Lorg/vidogram/messenger/ImageLoader;->bytesThumb:[B
    invoke-static {v2}, Lorg/vidogram/messenger/ImageLoader;->access$1502([B)[B
    ...
    invoke-static/range {v2 .. v7}, Lorg/vidogram/messenger/Utilities;->blurBitmap(Ljava/lang/Object;IIIII)V
    ...
    invoke-static {v2}, Lorg/vidogram/messenger/Utilities;->pinBitmap(Landroid/graphics/Bitmap;)I
    :try_end_14
    ...
    iget-object v6, v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->cacheImage:Lorg/vidogram/messenger/ImageLoader$CacheImage;

    iget-object v6, v6, Lorg/vidogram/messenger/ImageLoader$CacheImage;->httpUrl:Ljava/lang/String;
    ...
    iget-object v3, v3, Lorg/vidogram/messenger/ImageLoader$CacheImage;->httpUrl:Ljava/lang/String;
    ...
    iget-object v4, v0, Lorg/vidogram/messenger/ImageLoader$CacheOutTask;->this$0:Lorg/vidogram/messenger/ImageLoader;

    # getter for: Lorg/vidogram/messenger/ImageLoader;->lastCacheOutTime:J
    invoke-static {v4}, Lorg/vidogram/messenger/ImageLoader;->access$1400(Lorg/vidogram/messenger/ImageLoader;)J
    ...
    iget-object v4, v4, Lorg/vidogram/messenger/ImageLoader$CacheImage;->httpUrl:Ljava/lang/String;
    ...
    iget-object v6, v6, Lorg/vidogram/messenger/ImageLoader$CacheImage;->filter:Ljava/lang/String;
    ...
    # getter for: Lorg/vidogram/messenger/ImageLoader;->bytes:[B
    invoke-static {}, Lorg/vidogram/messenger/ImageLoader;->access$1600()[B
    ...
    # setter for: Lorg/vidogram/messenger/ImageLoader;->bytes:[B
    invoke-static {v2}, Lorg/vidogram/messenger/ImageLoader;->access$1602([B)[B
    ...
    invoke-static {v2, v7, v4, v8}, Lorg/vidogram/messenger/Bitmaps;->createScaledBitmap(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
