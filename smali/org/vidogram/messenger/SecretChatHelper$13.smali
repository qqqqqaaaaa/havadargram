.class Lorg/vidogram/messenger/SecretChatHelper$13;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/vidogram/messenger/SecretChatHelper;->acceptSecretChat(Lorg/vidogram/tgnet/TLRPC$EncryptedChat;)V
.end annotation
...
.method constructor <init>(Lorg/vidogram/messenger/SecretChatHelper;Lorg/vidogram/tgnet/TLRPC$EncryptedChat;)V
    ...
    iput-object p1, p0, Lorg/vidogram/messenger/SecretChatHelper$13;->this$0:Lorg/vidogram/messenger/SecretChatHelper;

    iput-object p2, p0, Lorg/vidogram/messenger/SecretChatHelper$13;->val$encryptedChat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;
...
.method public run(Lorg/vidogram/tgnet/TLObject;Lorg/vidogram/tgnet/TLRPC$TL_error;)V
    ...
    iget-object v0, p0, Lorg/vidogram/messenger/SecretChatHelper$13;->this$0:Lorg/vidogram/messenger/SecretChatHelper;
    ...
    iget-object v1, p0, Lorg/vidogram/messenger/SecretChatHelper$13;->val$encryptedChat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;
    ...
    invoke-virtual {v0, v1}, Lorg/vidogram/messenger/SecretChatHelper;->declineSecretChat(I)V
    ...
    :cond_2
    iget-object v0, p0, Lorg/vidogram/messenger/SecretChatHelper$13;->val$encryptedChat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;

    iput-object v3, v0, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->a_or_b:[B

    iget-object v0, p0, Lorg/vidogram/messenger/SecretChatHelper$13;->val$encryptedChat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;

    iput v9, v0, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->seq_in:I

    iget-object v0, p0, Lorg/vidogram/messenger/SecretChatHelper$13;->val$encryptedChat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;

    iput v2, v0, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->seq_out:I

    new-instance v4, Ljava/math/BigInteger;

    sget-object v0, Lorg/vidogram/messenger/MessagesStorage;->secretPBytes:[B
    ...
    iget-object v1, v1, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->g_a:[B

    invoke-direct {v5, v9, v1}, Ljava/math/BigInteger;-><init>(I[B)V

    invoke-static {v5, v4}, Lorg/vidogram/messenger/Utilities;->isGoodGaAndGb(Ljava/math/BigInteger;Ljava/math/BigInteger;)Z
    ...
    iget-object v2, p0, Lorg/vidogram/messenger/SecretChatHelper$13;->val$encryptedChat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;
    ...
    iput v2, v1, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->key_create_date:I

    new-instance v1, Lorg/vidogram/tgnet/TLRPC$TL_messages_acceptEncryption;

    invoke-direct {v1}, Lorg/vidogram/tgnet/TLRPC$TL_messages_acceptEncryption;-><init>()V

    iput-object v0, v1, Lorg/vidogram/tgnet/TLRPC$TL_messages_acceptEncryption;->g_b:[B

    new-instance v0, Lorg/vidogram/tgnet/TLRPC$TL_inputEncryptedChat;

    invoke-direct {v0}, Lorg/vidogram/tgnet/TLRPC$TL_inputEncryptedChat;-><init>()V

    iput-object v0, v1, Lorg/vidogram/tgnet/TLRPC$TL_messages_acceptEncryption;->peer:Lorg/vidogram/tgnet/TLRPC$TL_inputEncryptedChat;

    iget-object v0, v1, Lorg/vidogram/tgnet/TLRPC$TL_messages_acceptEncryption;->peer:Lorg/vidogram/tgnet/TLRPC$TL_inputEncryptedChat;

    iget-object v2, p0, Lorg/vidogram/messenger/SecretChatHelper$13;->val$encryptedChat:Lorg/vidogram/tgnet/TLRPC$EncryptedChat;

    iget v2, v2, Lorg/vidogram/tgnet/TLRPC$EncryptedChat;->id:I

    iput v2, v0, Lorg/vidogram/tgnet/TLRPC$TL_inputEncryptedChat;->chat_id:I
    ...
    iput-wide v2, v0, Lorg/vidogram/tgnet/TLRPC$TL_inputEncryptedChat;->access_hash:J

    invoke-static {v4}, Lorg/vidogram/messenger/Utilities;->bytesToLong([B)J

    move-result-wide v2

    iput-wide v2, v1, Lorg/vidogram/tgnet/TLRPC$TL_messages_acceptEncryption;->key_fingerprint:J

    invoke-static {}, Lorg/vidogram/tgnet/ConnectionsManager;->getInstance()Lorg/vidogram/tgnet/ConnectionsManager;

    move-result-object v0

    new-instance v2, Lorg/vidogram/messenger/SecretChatHelper$13$1;

    invoke-direct {v2, p0}, Lorg/vidogram/messenger/SecretChatHelper$13$1;-><init>(Lorg/vidogram/messenger/SecretChatHelper$13;)V
