.class public Lorg/vidogram/messenger/AndroidUtilities;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/vidogram/messenger/AndroidUtilities;->typefaceCache:Ljava/util/Hashtable;

    const/16 v0, -0xa

    sput v0, Lorg/vidogram/messenger/AndroidUtilities;->prevOrientation:I

    sput-boolean v1, Lorg/vidogram/messenger/AndroidUtilities;->waitingForSms:Z

    sput-boolean v1, Lorg/vidogram/messenger/AndroidUtilities;->waitingForCall:Z

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lorg/vidogram/messenger/AndroidUtilities;->smsLock:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lorg/vidogram/messenger/AndroidUtilities;->callLock:Ljava/lang/Object;

    sput v1, Lorg/vidogram/messenger/AndroidUtilities;->statusBarHeight:I

    const/high16 v0, 0x3f800000    # 1.0f

    sput v0, Lorg/vidogram/messenger/AndroidUtilities;->density:F

    new-instance v0, Landroid/graphics/Point;

    invoke-direct {v0}, Landroid/graphics/Point;-><init>()V

    sput-object v0, Lorg/vidogram/messenger/AndroidUtilities;->displaySize:Landroid/graphics/Point;

    sput-object v4, Lorg/vidogram/messenger/AndroidUtilities;->photoSize:Ljava/lang/Integer;

    new-instance v0, Landroid/util/DisplayMetrics;

    invoke-direct {v0}, Landroid/util/DisplayMetrics;-><init>()V

    sput-object v0, Lorg/vidogram/messenger/AndroidUtilities;->displayMetrics:Landroid/util/DisplayMetrics;

    sput-object v4, Lorg/vidogram/messenger/AndroidUtilities;->isTablet:Ljava/lang/Boolean;

    sput v1, Lorg/vidogram/messenger/AndroidUtilities;->adjustOwnerClassGuid:I

    sput-object v4, Lorg/vidogram/messenger/AndroidUtilities;->WEB_URL:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lorg/vidogram/messenger/AndroidUtilities;->WEB_URL:Ljava/util/regex/Pattern;
    :try_end_0
    ...
    :goto_1
    sput v0, Lorg/vidogram/messenger/AndroidUtilities;->leftBaseline:I

    sget-object v0, Lorg/vidogram/messenger/ApplicationLoader;->applicationContext:Landroid/content/Context;

    invoke-static {v0, v4}, Lorg/vidogram/messenger/AndroidUtilities;->checkDisplaySize(Landroid/content/Context;Landroid/content/res/Configuration;)V
    ...
    :goto_2
    sput-boolean v0, Lorg/vidogram/messenger/AndroidUtilities;->hasCallPermissions:Z
...
.method static synthetic access$000(ZLjava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lorg/vidogram/messenger/AndroidUtilities;->registerLoginContentObserver(ZLjava/lang/String;)V
...
.method static synthetic access$102(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    sput-object p0, Lorg/vidogram/messenger/AndroidUtilities;->unregisterRunnable:Ljava/lang/Runnable;
...
.method public static addMediaToGallery(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lorg/vidogram/messenger/AndroidUtilities;->addMediaToGallery(Landroid/net/Uri;)V
...
.method public static calcAuthKeyHash([B)[B
    ...
    invoke-static {p0}, Lorg/vidogram/messenger/Utilities;->computeSHA1([B)[B
...
.method public static calcDrawableColor(Landroid/graphics/drawable/Drawable;)[I
    ...
    invoke-static {v1, v2, v3, v4}, Lorg/vidogram/messenger/Bitmaps;->createScaledBitmap(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2, v0}, Lorg/vidogram/messenger/AndroidUtilities;->rgbToHsv(III)[D
    ...
    invoke-static/range {v0 .. v5}, Lorg/vidogram/messenger/AndroidUtilities;->hsvToRgb(DDD)[I
...
.method public static checkDisplaySize(Landroid/content/Context;Landroid/content/res/Configuration;)V
    ...
    sput v1, Lorg/vidogram/messenger/AndroidUtilities;->density:F
    ...
    :goto_0
    sput-boolean v0, Lorg/vidogram/messenger/AndroidUtilities;->usingHardwareInput:Z
    ...
    sget-object v1, Lorg/vidogram/messenger/AndroidUtilities;->displayMetrics:Landroid/util/DisplayMetrics;
...
.method public static checkForCrashes(Landroid/app/Activity;)V
    ...
    sget-object v0, Lorg/vidogram/messenger/BuildVars;->HOCKEY_APP_HASH_DEBUG:Ljava/lang/String;

    :goto_0
    new-instance v1, Lorg/vidogram/messenger/AndroidUtilities$5;

    invoke-direct {v1}, Lorg/vidogram/messenger/AndroidUtilities$5;-><init>()V
    ...
    :cond_0
    sget-object v0, Lorg/vidogram/messenger/BuildVars;->HOCKEY_APP_HASH:Ljava/lang/String;
...
.method public static checkPhonePattern(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Lorg/vidogram/a/b;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method private static createShortcutIntent(JZ)Landroid/content/Intent;
    ...
    const-class v2, Lorg/vidogram/messenger/OpenChatReceiver;
    ...
    invoke-virtual {v2, v0}, Lorg/vidogram/messenger/MessagesController;->getEncryptedChat(Ljava/lang/Integer;)Lorg/vidogram/tgnet/TLRPC$EncryptedChat;
    ...
    iget-object v0, v5, Lorg/vidogram/tgnet/TLRPC$User;->first_name:Ljava/lang/String;

    iget-object v2, v5, Lorg/vidogram/tgnet/TLRPC$User;->last_name:Ljava/lang/String;

    invoke-static {v0, v2}, Lorg/vidogram/messenger/ContactsController;->formatName(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iget-object v0, v5, Lorg/vidogram/tgnet/TLRPC$User;->photo:Lorg/vidogram/tgnet/TLRPC$UserProfilePhoto;
    ...
    sget-object v8, Lorg/vidogram/messenger/AndroidUtilities;->roundPaint:Landroid/graphics/Paint;
    ...
    sput-object v8, Lorg/vidogram/messenger/AndroidUtilities;->roundPaint:Landroid/graphics/Paint;

    new-instance v8, Landroid/graphics/RectF;

    invoke-direct {v8}, Landroid/graphics/RectF;-><init>()V

    sput-object v8, Lorg/vidogram/messenger/AndroidUtilities;->bitmapRect:Landroid/graphics/RectF;
    ...
    sget-object v7, Lorg/vidogram/messenger/AndroidUtilities;->bitmapRect:Landroid/graphics/RectF;
    ...
    sget-object v10, Lorg/vidogram/messenger/AndroidUtilities;->roundPaint:Landroid/graphics/Paint;
    ...
    :cond_8
    iget-object v2, v4, Lorg/vidogram/tgnet/TLRPC$Chat;->title:Ljava/lang/String;

    iget-object v0, v4, Lorg/vidogram/tgnet/TLRPC$Chat;->photo:Lorg/vidogram/tgnet/TLRPC$ChatPhoto;
    ...
    iget-boolean v0, v5, Lorg/vidogram/tgnet/TLRPC$User;->bot:Z
...
.method public static endIncomingCall()V
    ...
    sget-boolean v0, Lorg/vidogram/messenger/AndroidUtilities;->hasCallPermissions:Z
    ...
    invoke-interface {v0}, Lcom/a/a/a/a;->b()V
...
.method public static generatePicturePath()Ljava/io/File;
    ...
    :try_start_0
    invoke-static {}, Lorg/vidogram/messenger/AndroidUtilities;->getAlbumDir()Ljava/io/File;
...
.method private static getAlbumDir()Ljava/io/File;
    ...
    invoke-virtual {v0, v1}, Lorg/vidogram/messenger/FileLoader;->getDirectory(I)Ljava/io/File;
...
.method public static getPath(Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lorg/vidogram/messenger/AndroidUtilities;->isExternalStorageDocument(Landroid/net/Uri;)Z
    ...
    :cond_2
    invoke-static {p0}, Lorg/vidogram/messenger/AndroidUtilities;->isDownloadsDocument(Landroid/net/Uri;)Z
    ...
    invoke-static {v2, v1, v3, v4}, Lorg/vidogram/messenger/AndroidUtilities;->getDataColumn(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p0}, Lorg/vidogram/messenger/AndroidUtilities;->isMediaDocument(Landroid/net/Uri;)Z
    ...
    invoke-static {v3, v1, v4, v2}, Lorg/vidogram/messenger/AndroidUtilities;->getDataColumn(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, p0, v2, v3}, Lorg/vidogram/messenger/AndroidUtilities;->getDataColumn(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public static getPhotoSize()I
    ...
    sget-object v0, Lorg/vidogram/messenger/AndroidUtilities;->photoSize:Ljava/lang/Integer;
    ...
    sput-object v0, Lorg/vidogram/messenger/AndroidUtilities;->photoSize:Ljava/lang/Integer;
...
.method public static getPixelsInCM(FZ)F
    ...
    sget-object v0, Lorg/vidogram/messenger/AndroidUtilities;->displayMetrics:Landroid/util/DisplayMetrics;
...
.method public static getTypeface(Ljava/lang/String;)Landroid/graphics/Typeface;
    ...
    sget-object v1, Lorg/vidogram/messenger/AndroidUtilities;->typefaceCache:Ljava/util/Hashtable;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lorg/vidogram/messenger/AndroidUtilities;->typefaceCache:Ljava/util/Hashtable;
    ...
    sget-object v2, Lorg/vidogram/messenger/AndroidUtilities;->typefaceCache:Ljava/util/Hashtable;
...
.method public static getViewInset(Landroid/view/View;)I
    ...
    :cond_1
    :try_start_0
    sget-object v0, Lorg/vidogram/messenger/AndroidUtilities;->mAttachInfoField:Ljava/lang/reflect/Field;
    ...
    sput-object v0, Lorg/vidogram/messenger/AndroidUtilities;->mAttachInfoField:Ljava/lang/reflect/Field;
    ...
    sget-object v2, Lorg/vidogram/messenger/AndroidUtilities;->mStableInsetsField:Ljava/lang/reflect/Field;
    ...
    sput-object v2, Lorg/vidogram/messenger/AndroidUtilities;->mStableInsetsField:Ljava/lang/reflect/Field;
...
.method public static installShortcut(J)V
    ...
    :try_start_0
    invoke-static {p0, p1, v0}, Lorg/vidogram/messenger/AndroidUtilities;->createShortcutIntent(JZ)Landroid/content/Intent;
...
.method public static isGoogleMapsInstalled(Lorg/vidogram/ui/ActionBar/BaseFragment;)Z
    .locals 4
    ...
    new-instance v3, Lorg/vidogram/messenger/AndroidUtilities$1;

    invoke-direct {v3, p0}, Lorg/vidogram/messenger/AndroidUtilities$1;-><init>(Lorg/vidogram/ui/ActionBar/BaseFragment;)V
    ...
    invoke-virtual {p0, v1}, Lorg/vidogram/ui/ActionBar/BaseFragment;->showDialog(Landroid/app/Dialog;)Landroid/app/Dialog;
...
.method public static isInternalUri(Landroid/net/Uri;)Z
    ...
    :cond_1
    invoke-static {v0}, Lorg/vidogram/messenger/Utilities;->readlink(Ljava/lang/String;)Ljava/lang/String;
...
.method public static isTablet()Z
    ...
    sget-object v0, Lorg/vidogram/messenger/AndroidUtilities;->isTablet:Ljava/lang/Boolean;
    ...
    sput-object v0, Lorg/vidogram/messenger/AndroidUtilities;->isTablet:Ljava/lang/Boolean;
...
.method public static isWaitingForCall()Z
    ...
    sget-object v1, Lorg/vidogram/messenger/AndroidUtilities;->callLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    sget-boolean v0, Lorg/vidogram/messenger/AndroidUtilities;->waitingForCall:Z
...
.method public static isWaitingForSms()Z
    ...
    sget-object v1, Lorg/vidogram/messenger/AndroidUtilities;->smsLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    sget-boolean v0, Lorg/vidogram/messenger/AndroidUtilities;->waitingForSms:Z
...
.method public static lockOrientation(Landroid/app/Activity;)V
    ...
    sget v0, Lorg/vidogram/messenger/AndroidUtilities;->prevOrientation:I
...
.method public static needShowPasscode(Z)Z
    ...
    invoke-static {}, Lorg/vidogram/ui/Components/ForegroundDetector;->getInstance()Lorg/vidogram/ui/Components/ForegroundDetector;

    move-result-object v0

    invoke-virtual {v0, p0}, Lorg/vidogram/ui/Components/ForegroundDetector;->isWasInBackground(Z)Z
    ...
    invoke-virtual {v1}, Lorg/vidogram/ui/Components/ForegroundDetector;->resetBackgroundVar()V

    :cond_0
    sget-object v1, Lorg/vidogram/messenger/UserConfig;->passcodeHash:Ljava/lang/String;
...
.method public static obtainLoginPhoneCall(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lorg/vidogram/messenger/AndroidUtilities;->checkPhonePattern(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method public static openForView(Lorg/vidogram/messenger/MessageObject;Landroid/app/Activity;)V
    .locals 9
    ...
    iget v3, p0, Lorg/vidogram/messenger/MessageObject;->type:I
    ...
    const-string/jumbo v1, "org.vidogram.messenger.provider"
    ...
    const-string/jumbo v0, "org.vidogram.messenger.provider"

    invoke-static {p1, v0, v2}, Landroid/support/v4/content/FileProvider;->a(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;)Landroid/net/Uri;
...
.method public static openForView(Lorg/vidogram/tgnet/TLObject;Landroid/app/Activity;)V
    .locals 9
    ...
    :cond_1
    invoke-static {p0}, Lorg/vidogram/messenger/FileLoader;->getAttachFileName(Lorg/vidogram/tgnet/TLObject;)Ljava/lang/String;

    move-result-object v0

    invoke-static {p0, v5}, Lorg/vidogram/messenger/FileLoader;->getPathToAttach(Lorg/vidogram/tgnet/TLObject;Z)Ljava/io/File;
    ...
    instance-of v4, p0, Lorg/vidogram/tgnet/TLRPC$TL_document;

    if-eqz v4, :cond_2

    check-cast p0, Lorg/vidogram/tgnet/TLRPC$TL_document;
...
.method private static registerLoginContentObserver(ZLjava/lang/String;)V
    ...
    sget-object v0, Lorg/vidogram/messenger/AndroidUtilities;->callLogContentObserver:Landroid/database/ContentObserver;
    ...
    new-instance v3, Lorg/vidogram/messenger/AndroidUtilities$2;

    new-instance v4, Landroid/os/Handler;

    invoke-direct {v4}, Landroid/os/Handler;-><init>()V

    invoke-direct {v3, v4, p1}, Lorg/vidogram/messenger/AndroidUtilities$2;-><init>(Landroid/os/Handler;Ljava/lang/String;)V

    sput-object v3, Lorg/vidogram/messenger/AndroidUtilities;->callLogContentObserver:Landroid/database/ContentObserver;

    invoke-virtual {v0, v1, v2, v3}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V

    new-instance v0, Lorg/vidogram/messenger/AndroidUtilities$3;

    invoke-direct {v0, p1}, Lorg/vidogram/messenger/AndroidUtilities$3;-><init>(Ljava/lang/String;)V

    sput-object v0, Lorg/vidogram/messenger/AndroidUtilities;->unregisterRunnable:Ljava/lang/Runnable;
    ...
    sget-object v0, Lorg/vidogram/messenger/AndroidUtilities;->unregisterRunnable:Ljava/lang/Runnable;
    ...
    sput-object v2, Lorg/vidogram/messenger/AndroidUtilities;->unregisterRunnable:Ljava/lang/Runnable;
    ...
    sget-object v1, Lorg/vidogram/messenger/AndroidUtilities;->callLogContentObserver:Landroid/database/ContentObserver;
    ...
    sput-object v2, Lorg/vidogram/messenger/AndroidUtilities;->callLogContentObserver:Landroid/database/ContentObserver;
...
.method public static removeAdjustResize(Landroid/app/Activity;I)V
    ...
    :cond_1
    sget v0, Lorg/vidogram/messenger/AndroidUtilities;->adjustOwnerClassGuid:I
...
.method public static removeLoginPhoneCall(Ljava/lang/String;Z)V
    ...
    invoke-static {v0, p0}, Lorg/vidogram/messenger/AndroidUtilities;->registerLoginContentObserver(ZLjava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method public static replaceTags(Ljava/lang/String;)Landroid/text/SpannableStringBuilder;
    ...
    invoke-static {p0, v0}, Lorg/vidogram/messenger/AndroidUtilities;->replaceTags(Ljava/lang/String;I)Landroid/text/SpannableStringBuilder;
...
.method public static replaceTags(Ljava/lang/String;I)Landroid/text/SpannableStringBuilder;
    ...
    new-instance v4, Lorg/vidogram/ui/Components/TypefaceSpan;
    ...
    invoke-direct {v4, v0}, Lorg/vidogram/ui/Components/TypefaceSpan;-><init>(Landroid/graphics/Typeface;)V
...
.method public static requestAdjustResize(Landroid/app/Activity;I)V
    ...
    sput p1, Lorg/vidogram/messenger/AndroidUtilities;->adjustOwnerClassGuid:I
...
.method public static setViewPagerEdgeEffectColor(Landroid/support/v4/view/ViewPager;I)V
    ...
    const-class v1, Landroid/support/v4/widget/i;
...
.method public static setWaitingForCall(Z)V
    ...
    :try_start_0
    sput-boolean p0, Lorg/vidogram/messenger/AndroidUtilities;->waitingForCall:Z
...
.method public static setWaitingForSms(Z)V
    ...
    :try_start_0
    sput-boolean p0, Lorg/vidogram/messenger/AndroidUtilities;->waitingForSms:Z
...
.method public static shakeView(Landroid/view/View;FI)V
    ...
    new-instance v1, Lorg/vidogram/messenger/AndroidUtilities$4;

    invoke-direct {v1, p0, p2, p1}, Lorg/vidogram/messenger/AndroidUtilities$4;-><init>(Landroid/view/View;IF)V
...
.method public static unregisterUpdates()V
    ...
    invoke-static {}, Lnet/hockeyapp/android/m;->a()V
