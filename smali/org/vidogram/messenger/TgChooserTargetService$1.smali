.class Lorg/vidogram/messenger/TgChooserTargetService$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/vidogram/messenger/TgChooserTargetService;->onGetChooserTargets(Landroid/content/ComponentName;Landroid/content/IntentFilter;)Ljava/util/List;
.end annotation
...
# instance fields
.field final synthetic this$0:Lorg/vidogram/messenger/TgChooserTargetService;
...
# direct methods
.method constructor <init>(Lorg/vidogram/messenger/TgChooserTargetService;Ljava/util/List;Landroid/content/ComponentName;Ljava/util/concurrent/Semaphore;)V
    .locals 0

    iput-object p1, p0, Lorg/vidogram/messenger/TgChooserTargetService$1;->this$0:Lorg/vidogram/messenger/TgChooserTargetService;

    iput-object p2, p0, Lorg/vidogram/messenger/TgChooserTargetService$1;->val$targets:Ljava/util/List;

    iput-object p3, p0, Lorg/vidogram/messenger/TgChooserTargetService$1;->val$componentName:Landroid/content/ComponentName;

    iput-object p4, p0, Lorg/vidogram/messenger/TgChooserTargetService$1;->val$semaphore:Ljava/util/concurrent/Semaphore;
...
.method public run()V
    ...
    invoke-virtual {v2, v1, v10}, Lorg/vidogram/messenger/MessagesStorage;->getChatsInternal(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v1, v0, v11}, Lorg/vidogram/messenger/MessagesStorage;->getUsersInternal(Ljava/lang/String;Ljava/util/ArrayList;)V
    :try_end_0
    ...
    iget-object v1, p0, Lorg/vidogram/messenger/TgChooserTargetService$1;->this$0:Lorg/vidogram/messenger/TgChooserTargetService;
    ...
    invoke-static {v2, v13}, Lorg/vidogram/messenger/FileLoader;->getPathToAttach(Lorg/vidogram/tgnet/TLObject;Z)Ljava/io/File;

    move-result-object v2

    # invokes: Lorg/vidogram/messenger/TgChooserTargetService;->createRoundBitmap(Ljava/io/File;)Landroid/graphics/drawable/Icon;
    invoke-static {v1, v2}, Lorg/vidogram/messenger/TgChooserTargetService;->access$000(Lorg/vidogram/messenger/TgChooserTargetService;Ljava/io/File;)Landroid/graphics/drawable/Icon;
    ...
    :cond_5
    iget-object v12, p0, Lorg/vidogram/messenger/TgChooserTargetService$1;->val$targets:Ljava/util/List;

    new-instance v0, Landroid/service/chooser/ChooserTarget;

    const/high16 v3, 0x3f800000    # 1.0f

    iget-object v4, p0, Lorg/vidogram/messenger/TgChooserTargetService$1;->val$componentName:Landroid/content/ComponentName;
    ...
    iget-object v2, v2, Lorg/vidogram/tgnet/TLRPC$ChatPhoto;->photo_small:Lorg/vidogram/tgnet/TLRPC$FileLocation;
    ...
    :cond_c
    iget-object v0, p0, Lorg/vidogram/messenger/TgChooserTargetService$1;->val$semaphore:Ljava/util/concurrent/Semaphore;
