...
.method private d(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    invoke-virtual {v6, v7}, Landroid/support/v4/b/r$d;->c(Z)Landroid/support/v4/b/r$d;

    move-result-object v6

    invoke-virtual {v6, v2}, Landroid/support/v4/b/r$d;->a(I)Landroid/support/v4/b/r$d;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/b/r$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/b/r$d;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/b/r$d;->e(I)Landroid/support/v4/b/r$d;

    :cond_1
    if-eqz v4, :cond_2

    invoke-virtual {v2, v4}, Landroid/support/v4/b/r$d;->a(Landroid/net/Uri;)Landroid/support/v4/b/r$d;

    :cond_2
    if-eqz v5, :cond_3

    invoke-virtual {v2, v5}, Landroid/support/v4/b/r$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/b/r$d;
...
.method private e(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {v0}, Lcom/google/android/gms/gcm/a;->zzD(Landroid/os/Bundle;)V
