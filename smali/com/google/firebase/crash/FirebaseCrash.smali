...
.field private c:Lcom/google/android/gms/b/df;

.field private d:Lcom/google/android/gms/b/db;
...
.method constructor <init>(Lcom/google/firebase/a;Z)V
    ...
    const-string/jumbo v2, "Application context is missing, disabling api"
    ...
    new-instance v3, Lcom/google/android/gms/b/dd;

    invoke-direct {v3, v2, v1}, Lcom/google/android/gms/b/dd;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {}, Lcom/google/android/gms/b/dg;->a()Lcom/google/android/gms/b/dg;

    move-result-object v1

    invoke-virtual {v1, v0}, Lcom/google/android/gms/b/dg;->a(Landroid/content/Context;)V

    invoke-static {}, Lcom/google/android/gms/b/dg;->a()Lcom/google/android/gms/b/dg;

    move-result-object v1

    invoke-virtual {v1}, Lcom/google/android/gms/b/dg;->b()Lcom/google/android/gms/b/df;

    move-result-object v1

    iput-object v1, p0, Lcom/google/firebase/crash/FirebaseCrash;->c:Lcom/google/android/gms/b/df;

    iget-object v1, p0, Lcom/google/firebase/crash/FirebaseCrash;->c:Lcom/google/android/gms/b/df;

    invoke-static {v0}, Lcom/google/android/gms/a/d;->a(Ljava/lang/Object;)Lcom/google/android/gms/a/a;

    move-result-object v2

    invoke-interface {v1, v2, v3}, Lcom/google/android/gms/b/df;->a(Lcom/google/android/gms/a/a;Lcom/google/android/gms/b/dd;)V

    new-instance v1, Lcom/google/android/gms/b/db;

    invoke-direct {v1, v0}, Lcom/google/android/gms/b/db;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/google/firebase/crash/FirebaseCrash;->d:Lcom/google/android/gms/b/db;

    invoke-direct {p0}, Lcom/google/firebase/crash/FirebaseCrash;->f()V

    sget-object v1, Lcom/google/firebase/crash/FirebaseCrash;->a:Ljava/lang/String;

    const-string/jumbo v2, "FirebaseCrash reporting initialized "
    ...
    const-string/jumbo v2, "Failed to initialize crash reporting: "
...
.method public static a(Ljava/lang/String;JLandroid/os/Bundle;)V
    ...
    :try_end_0
    .catch Lcom/google/android/gms/b/dc; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/b/dc;->getMessage()Ljava/lang/String;
...
.method private b()V
    ...
    invoke-direct {v0, v1}, Lcom/google/android/gms/b/dc;-><init>(Ljava/lang/String;)V

    throw v0

    :cond_0
    iget-object v0, p0, Lcom/google/firebase/crash/FirebaseCrash;->d:Lcom/google/android/gms/b/db;

    invoke-virtual {v0}, Lcom/google/android/gms/b/db;->a()V

    return-void
.end method

.method private c()Lcom/google/android/gms/b/df;
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/crash/FirebaseCrash;->c:Lcom/google/android/gms/b/df;
...
.method private f()V
    ...
    const-string/jumbo v1, "FirebaseCrash reporting may only be initialized on the main thread (preferably in your app\'s Application.onCreate)"
    ...
    invoke-direct {v1, v0, p0}, Lcom/google/android/gms/b/dh;-><init>(Ljava/lang/Thread$UncaughtExceptionHandler;Lcom/google/firebase/crash/FirebaseCrash;)V
...
.method public static getInstance(Lcom/google/firebase/a;)Lcom/google/firebase/crash/FirebaseCrash;
    ...
    invoke-static {v0}, Lcom/google/android/gms/b/di;->a(Landroid/content/Context;)V

    sget-object v0, Lcom/google/android/gms/b/di;->a:Lcom/google/android/gms/b/w;

    invoke-virtual {v0}, Lcom/google/android/gms/b/w;->c()Ljava/lang/Object;
    ...
    :try_end_1
    .catch Lcom/google/android/gms/b/dc; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public b(Ljava/lang/String;JLandroid/os/Bundle;)V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/firebase/crash/FirebaseCrash;->c()Lcom/google/android/gms/b/df;
    ...
    :try_start_0
    invoke-interface {v0, p1, p2, p3, p4}, Lcom/google/android/gms/b/df;->a(Ljava/lang/String;JLandroid/os/Bundle;)V
    :try_end_0
...
.method public b(Ljava/lang/Throwable;)V
    ...
    iget-object v1, p0, Lcom/google/firebase/crash/FirebaseCrash;->d:Lcom/google/android/gms/b/db;
    ...
    invoke-virtual {v1, v2, v4, v5}, Lcom/google/android/gms/b/db;->a(ZJ)V
    ...
    invoke-interface {v0, v1}, Lcom/google/android/gms/b/df;->b(Ljava/lang/String;)V

    invoke-static {p1}, Lcom/google/android/gms/a/d;->a(Ljava/lang/Object;)Lcom/google/android/gms/a/a;

    move-result-object v1

    invoke-interface {v0, v1}, Lcom/google/android/gms/b/df;->a(Lcom/google/android/gms/a/a;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public c(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, v1}, Lcom/google/android/gms/b/df;->b(Lcom/google/android/gms/a/a;)V
