...
.field private final q:Landroid/support/v4/f/g;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/google/firebase/iid/f;->b:Z

    sput v0, Lcom/google/firebase/iid/f;->c:I

    sput v0, Lcom/google/firebase/iid/f;->d:I

    sput v0, Lcom/google/firebase/iid/f;->e:I

    sput-object v1, Lcom/google/firebase/iid/f;->f:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/f;->q:Landroid/support/v4/f/g;

    iput-object p1, p0, Lcom/google/firebase/iid/f;->g:Landroid/content/Context;
...
.method public static a(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/firebase/iid/f;->b(Landroid/content/pm/PackageManager;)Z

    move-result v1

    if-nez v1, :cond_1

    invoke-static {v0}, Lcom/google/firebase/iid/f;->a(Landroid/content/pm/PackageManager;)Z
    ...
    invoke-static {v0, v1}, Lcom/google/firebase/iid/f;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
...
.method private a(Ljava/lang/String;)V
    ...
    sget-object v1, Lcom/google/firebase/iid/f;->a:Ljava/lang/String;
    ...
    :cond_1
    iget v0, p0, Lcom/google/firebase/iid/f;->n:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lcom/google/firebase/iid/f;->n:I
    ...
    iput v0, p0, Lcom/google/firebase/iid/f;->o:I

    :cond_2
    iget v0, p0, Lcom/google/firebase/iid/f;->o:I
    ...
    iget v2, p0, Lcom/google/firebase/iid/f;->o:I

    int-to-long v2, v2

    add-long/2addr v0, v2

    iput-wide v0, p0, Lcom/google/firebase/iid/f;->p:J

    const-string/jumbo v0, "InstanceID/Rpc"

    iget v1, p0, Lcom/google/firebase/iid/f;->o:I
...
.method private a(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    iget-object v1, p0, Lcom/google/firebase/iid/f;->q:Landroid/support/v4/f/g;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/iid/f;->q:Landroid/support/v4/f/g;
...
.method private a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/google/firebase/iid/f;->q:Landroid/support/v4/f/g;
    ...
    invoke-virtual {v0}, Landroid/support/v4/f/g;->clear()V
...
.method private static a(Landroid/content/pm/PackageManager;)Z
    ...
    invoke-static {p0, v0, v3}, Lcom/google/firebase/iid/f;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    sput-boolean v1, Lcom/google/firebase/iid/f;->b:Z
...
.method private static a(Landroid/content/pm/PackageManager;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1}, Lcom/google/firebase/iid/f;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
...
.method private b(Landroid/os/Bundle;Ljava/security/KeyPair;)Landroid/content/Intent;
    ...
    invoke-static {}, Lcom/google/firebase/iid/f;->c()Ljava/lang/String;
    ...
    invoke-direct {v1, v2}, Lcom/google/firebase/iid/f$a;-><init>(Lcom/google/firebase/iid/f$1;)V
    ...
    :try_start_0
    iget-object v3, p0, Lcom/google/firebase/iid/f;->q:Landroid/support/v4/f/g;

    invoke-virtual {v3, v0, v1}, Landroid/support/v4/f/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    monitor-exit v2
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/firebase/iid/f;->a(Landroid/os/Bundle;Ljava/security/KeyPair;Ljava/lang/String;)V

    :try_start_1
    invoke-virtual {v1}, Lcom/google/firebase/iid/f$a;->a()Landroid/content/Intent;
    :try_end_1
    ...
    invoke-virtual {v3, v0}, Landroid/support/v4/f/g;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static b(Landroid/content/pm/PackageManager;)Z
    ...
    invoke-static {p0, v0, v4}, Lcom/google/firebase/iid/f;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static declared-synchronized c()Ljava/lang/String;
    ...
    :try_start_0
    sget v0, Lcom/google/firebase/iid/f;->e:I

    add-int/lit8 v2, v0, 0x1

    sput v2, Lcom/google/firebase/iid/f;->e:I
...
.method a()V
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/f;->h:Landroid/os/Messenger;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/firebase/iid/f;->g:Landroid/content/Context;

    invoke-static {v0}, Lcom/google/firebase/iid/f;->a(Landroid/content/Context;)Ljava/lang/String;

    new-instance v0, Landroid/os/Messenger;

    new-instance v1, Lcom/google/firebase/iid/f$1;

    invoke-static {}, Landroid/os/Looper;->getMainLooper()Landroid/os/Looper;

    move-result-object v2

    invoke-direct {v1, p0, v2}, Lcom/google/firebase/iid/f$1;-><init>(Lcom/google/firebase/iid/f;Landroid/os/Looper;)V

    invoke-direct {v0, v1}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/google/firebase/iid/f;->h:Landroid/os/Messenger;
...
.method declared-synchronized a(Landroid/content/Intent;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/iid/f;->k:Landroid/app/PendingIntent;
    ...
    iget-object v1, p0, Lcom/google/firebase/iid/f;->g:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/f;->k:Landroid/app/PendingIntent;

    :cond_0
    const-string/jumbo v0, "app"

    iget-object v1, p0, Lcom/google/firebase/iid/f;->k:Landroid/app/PendingIntent;
...
.method protected a(Landroid/content/Intent;Ljava/lang/String;)V
    ...
    iput-wide v0, p0, Lcom/google/firebase/iid/f;->l:J
    ...
    iget-object v1, p0, Lcom/google/firebase/iid/f;->h:Landroid/os/Messenger;

    invoke-virtual {p1, v0, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    iget-object v0, p0, Lcom/google/firebase/iid/f;->i:Landroid/os/Messenger;

    if-nez v0, :cond_2

    iget-object v0, p0, Lcom/google/firebase/iid/f;->j:Lcom/google/android/gms/iid/MessengerCompat;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/iid/f;->i:Landroid/os/Messenger;
    ...
    :cond_3
    sget-boolean v0, Lcom/google/firebase/iid/f;->b:Z
    ...
    :cond_4
    :try_start_1
    iget-object v1, p0, Lcom/google/firebase/iid/f;->j:Lcom/google/android/gms/iid/MessengerCompat;
...
.method public a(Landroid/os/Bundle;Ljava/security/KeyPair;Ljava/lang/String;)V
    ...
    iget-wide v2, p0, Lcom/google/firebase/iid/f;->p:J
    ...
    iget-wide v4, p0, Lcom/google/firebase/iid/f;->p:J

    sub-long v0, v4, v0

    iget v3, p0, Lcom/google/firebase/iid/f;->o:I
    ...
    iget-object v2, p0, Lcom/google/firebase/iid/f;->g:Landroid/content/Context;

    iget-object v3, p0, Lcom/google/firebase/iid/f;->g:Landroid/content/Context;

    invoke-static {v3}, Lcom/google/firebase/iid/f;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/google/firebase/iid/f;->g:Landroid/content/Context;
    ...
    invoke-static {p2, v3}, Lcom/google/firebase/iid/f;->a(Ljava/security/KeyPair;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/google/firebase/iid/f;->a(Landroid/content/Intent;)V

    invoke-virtual {p0, v1, p3}, Lcom/google/firebase/iid/f;->a(Landroid/content/Intent;Ljava/lang/String;)V
...
.method a(Landroid/os/Message;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/f;->j:Lcom/google/android/gms/iid/MessengerCompat;
    ...
    iput-object v1, p0, Lcom/google/firebase/iid/f;->i:Landroid/os/Messenger;
    ...
    invoke-virtual {p0, v0}, Lcom/google/firebase/iid/f;->d(Landroid/content/Intent;)V
...
.method b()V
    ...
    :try_start_0
    sget-object v0, Lcom/google/firebase/iid/f;->f:Landroid/content/BroadcastReceiver;

    if-nez v0, :cond_1

    new-instance v0, Lcom/google/firebase/iid/f$2;

    invoke-direct {v0, p0}, Lcom/google/firebase/iid/f$2;-><init>(Lcom/google/firebase/iid/f;)V

    sput-object v0, Lcom/google/firebase/iid/f;->f:Landroid/content/BroadcastReceiver;
    ...
    const-string/jumbo v1, "Registered GSF callback receiver"
    ...
    sget-object v2, Lcom/google/firebase/iid/f;->f:Landroid/content/BroadcastReceiver;

    const-string/jumbo v3, "com.google.android.c2dm.permission.SEND"
...
.method c(Landroid/content/Intent;)V
    ...
    iput-wide v0, p0, Lcom/google/firebase/iid/f;->m:J
    ...
    :cond_9
    invoke-direct {p0, v1}, Lcom/google/firebase/iid/f;->a(Ljava/lang/String;)V
...
.method d(Landroid/content/Intent;)V
    ...
    iput-wide v4, p0, Lcom/google/firebase/iid/f;->l:J

    const-wide/16 v4, 0x0

    iput-wide v4, p0, Lcom/google/firebase/iid/f;->p:J

    iput v3, p0, Lcom/google/firebase/iid/f;->n:I

    iput v3, p0, Lcom/google/firebase/iid/f;->o:I
    ...
    invoke-static {v3, v2}, Lcom/google/firebase/iid/d;->a(Landroid/content/Context;Landroid/os/Bundle;)Lcom/google/firebase/iid/d;

    move-result-object v2

    invoke-virtual {v2}, Lcom/google/firebase/iid/d;->c()Lcom/google/firebase/iid/h;

    move-result-object v2

    invoke-static {v0, v2}, Lcom/google/firebase/iid/FirebaseInstanceId;->a(Landroid/content/Context;Lcom/google/firebase/iid/h;)V
    ...
    :cond_b
    invoke-direct {p0, v0, p1}, Lcom/google/firebase/iid/f;->a(Ljava/lang/String;Landroid/content/Intent;)V
