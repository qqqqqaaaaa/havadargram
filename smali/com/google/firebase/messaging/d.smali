...
# static fields
.field static a:Lcom/google/firebase/messaging/d;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/d;->d:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Lcom/google/firebase/messaging/d;->b:Landroid/content/Context;
...
.method private a(Landroid/os/Bundle;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v0, p1}, Lcom/google/firebase/messaging/d;->a(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Lcom/google/firebase/messaging/d;->b()I

    move-result v2

    const/high16 v3, 0x40000000    # 2.0f

    invoke-static {v1, v2, v0, v3}, Lcom/google/firebase/iid/g;->b(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method static declared-synchronized a(Landroid/content/Context;)Lcom/google/firebase/messaging/d;
    .locals 2

    const-class v1, Lcom/google/firebase/messaging/d;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/google/firebase/messaging/d;->a:Lcom/google/firebase/messaging/d;

    if-nez v0, :cond_0

    new-instance v0, Lcom/google/firebase/messaging/d;

    invoke-direct {v0, p0}, Lcom/google/firebase/messaging/d;-><init>(Landroid/content/Context;)V
...
.method private b()I
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/d;->d:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private b(Ljava/lang/String;)I
    ...
    const-string/jumbo v1, "Icon resource "
    ...
    const-string/jumbo v2, " not found. Notification will use default icon."
    ...
    :cond_2
    invoke-direct {p0}, Lcom/google/firebase/messaging/d;->c()Landroid/os/Bundle;

    move-result-object v0

    const-string/jumbo v1, "com.google.firebase.messaging.default_notification_icon"
...
.method private c(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-static {v2, v1}, Landroid/support/v4/content/a;->c(Landroid/content/Context;I)I
...
.method static c(Landroid/os/Bundle;Ljava/lang/String;)[Ljava/lang/Object;
    ...
    :goto_3
    invoke-static {v0}, Lcom/google/firebase/messaging/d;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private e(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/d;->b(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/d;->c(Ljava/lang/String;)Ljava/lang/Integer;

    move-result-object v5

    invoke-static {p1}, Lcom/google/firebase/messaging/d;->d(Landroid/os/Bundle;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/d;->d(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v6

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/d;->f(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, p1, v1}, Lcom/google/firebase/messaging/d;->a(Landroid/os/Bundle;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;

    move-result-object v1

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/d;->h(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v0

    :cond_0
    new-instance v7, Landroid/support/v4/b/r$d;

    iget-object v8, p0, Lcom/google/firebase/messaging/d;->b:Landroid/content/Context;

    invoke-direct {v7, v8}, Landroid/support/v4/b/r$d;-><init>(Landroid/content/Context;)V

    const/4 v8, 0x1

    invoke-virtual {v7, v8}, Landroid/support/v4/b/r$d;->c(Z)Landroid/support/v4/b/r$d;

    move-result-object v7

    invoke-virtual {v7, v4}, Landroid/support/v4/b/r$d;->a(I)Landroid/support/v4/b/r$d;
    ...
    invoke-virtual {v4, v2}, Landroid/support/v4/b/r$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/b/r$d;
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/b/r$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/b/r$d;

    new-instance v2, Landroid/support/v4/b/r$c;

    invoke-direct {v2}, Landroid/support/v4/b/r$c;-><init>()V

    invoke-virtual {v2, v3}, Landroid/support/v4/b/r$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/b/r$c;

    move-result-object v2

    invoke-virtual {v4, v2}, Landroid/support/v4/b/r$d;->a(Landroid/support/v4/b/r$s;)Landroid/support/v4/b/r$d;
    ...
    invoke-virtual {v4, v2}, Landroid/support/v4/b/r$d;->e(I)Landroid/support/v4/b/r$d;

    :cond_2
    if-eqz v6, :cond_3

    invoke-virtual {v4, v6}, Landroid/support/v4/b/r$d;->a(Landroid/net/Uri;)Landroid/support/v4/b/r$d;

    :cond_3
    if-eqz v1, :cond_4

    invoke-virtual {v4, v1}, Landroid/support/v4/b/r$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/b/r$d;

    :cond_4
    if-eqz v0, :cond_5

    invoke-virtual {v4, v0}, Landroid/support/v4/b/r$d;->b(Landroid/app/PendingIntent;)Landroid/support/v4/b/r$d;

    :cond_5
    invoke-virtual {v4}, Landroid/support/v4/b/r$d;->b()Landroid/app/Notification;
    ...
    iget-object v7, p0, Lcom/google/firebase/messaging/d;->b:Landroid/content/Context;
...
.method private f(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/d;->g(Landroid/os/Bundle;)Landroid/content/Intent;
...
.method private g(Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    :cond_1
    invoke-static {p1}, Lcom/google/firebase/messaging/d;->b(Landroid/os/Bundle;)Landroid/net/Uri;
...
.method c(Landroid/os/Bundle;)Z
    ...
    const-string/jumbo v2, "gcm.n.noui"
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/firebase/messaging/d;->a()Z
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/d;->e(Landroid/os/Bundle;)Landroid/app/Notification;

    move-result-object v1

    const-string/jumbo v2, "gcm.n.tag"

    invoke-static {p1, v2}, Lcom/google/firebase/messaging/d;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-direct {p0, v2, v1}, Lcom/google/firebase/messaging/d;->a(Ljava/lang/String;Landroid/app/Notification;)V
