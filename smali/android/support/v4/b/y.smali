...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/b/y;->a:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Landroid/support/v4/b/y;->d:Ljava/lang/Object;

    return-void
.end method

.method public static a(Landroid/app/Notification$Builder;Landroid/support/v4/b/v$a;)Landroid/os/Bundle;
    .locals 3
    ...
    invoke-static {v2}, Landroid/support/v4/b/ag;->a([Landroid/support/v4/b/af$a;)[Landroid/os/Bundle;
...
.method public static a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    sget-object v2, Landroid/support/v4/b/y;->a:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    sget-boolean v0, Landroid/support/v4/b/y;->c:Z
    ...
    :cond_0
    :try_start_1
    sget-object v0, Landroid/support/v4/b/y;->b:Ljava/lang/reflect/Field;
    ...
    sput-boolean v0, Landroid/support/v4/b/y;->c:Z
    :try_end_1
    ...
    sput-object v0, Landroid/support/v4/b/y;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v3, Landroid/support/v4/b/y;->b:Ljava/lang/reflect/Field;
...
.method private static a(Landroid/support/v4/b/v$a;)Landroid/os/Bundle;
    .locals 4
...
.method public static a([Landroid/support/v4/b/v$a;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Landroid/support/v4/b/y;->a(Landroid/support/v4/b/v$a;)Landroid/os/Bundle;
...
.method public static a(Landroid/support/v4/b/q;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Z)V
    .locals 2

    new-instance v0, Landroid/app/Notification$BigPictureStyle;

    invoke-interface {p0}, Landroid/support/v4/b/q;->a()Landroid/app/Notification$Builder;
...
.method public static a(Landroid/support/v4/b/q;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Ljava/lang/CharSequence;)V
    .locals 2
...
.method public static a(Landroid/support/v4/b/q;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Ljava/util/ArrayList;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
