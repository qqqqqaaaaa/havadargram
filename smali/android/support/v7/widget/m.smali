...
.method private a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/f/c;->a(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/f/c;->b(J)V
...
.method private a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, v3}, Landroid/support/v4/f/c;->b(JLjava/lang/Object;)V
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/m;->l:Landroid/support/v4/f/h;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/m;->l:Landroid/support/v4/f/h;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/m;->l:Landroid/support/v4/f/h;

    const-string/jumbo v2, "appcompat_skip_skip"

    invoke-virtual {v1, p2, v2}, Landroid/support/v4/f/h;->c(ILjava/lang/Object;)V
    ...
    iget-object v7, p0, Landroid/support/v7/widget/m;->l:Landroid/support/v4/f/h;

    invoke-virtual {v7, p2, v0}, Landroid/support/v4/f/h;->c(ILjava/lang/Object;)V
...
.method a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/m;->d(Landroid/content/Context;)V
